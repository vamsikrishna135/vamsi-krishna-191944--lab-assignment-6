...
#include<string.h>
 ...
 public:
    ...
    void add_strings()             // addition of strings//
    {
        result=str2+str3;
    }
    ...
    void equate_strings()           //Default Constructor//
    {
               int k= str1.compare(str2);
                      if(k==0)
                         cout<<"Both the strings are equal"<<endl;              // comparison of strings //
                     else
    ...
    void display_strings()              // output strings is named as display here //
    {
        cout<<"The result of Concatenation of two strings is: "<<result<<endl;          // concatenation //
    }
